...
@st.cache_data
def load_data():
    df = pd.read_csv("https://raw.githubusercontent.com/BrendoGarcia/BigData/main/processed_data.csv") #https://raw.githubusercontent.com/BrendoGarcia/BigData/main/processed_data.csv
    return df
